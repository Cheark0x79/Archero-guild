...
env_file="${1:-platform/.env.production}"
compose_file="${COMPOSE_FILE:-platform/compose.yml}"
backup_root="${BACKUP_DIR:-backups/pre-release}"
...
temporary="$backup_root/.tmp-$timestamp-$$"
