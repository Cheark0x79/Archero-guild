...
import { findMember, memberWarningsFromData, membersFromData } from "../../../_lib/domain.js";
...
export async function GET(request, { params }) {
  ...
  const result = memberWarningsFromData(payload.data, playerId, request.nextUrl.searchParams);
