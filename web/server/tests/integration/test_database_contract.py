...
from archero_guild.storage.export_json import export_dashboard_payload
from archero_guild.storage.rules import read_rules, write_rules
...
class DatabaseContractTests(unittest.TestCase):
    ...
    def test_real_database_export_contains_only_seeded_live_data(self) -> None:
        ...
        self.assertNotIn("900000108", {member["playerId"] for member in payload["guildRoster"]})
