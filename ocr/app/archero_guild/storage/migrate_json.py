...
from archero_guild.import_capture import read_roster_entries
...
from archero_guild.pipeline.guild_member_ocr import ExtractedMemberMetrics, extract_member_metrics_from_screenshots
from archero_guild.storage.persistence import database_url_from_env, persist_import_report
...
def migrate_import_reports(
    *,
    ...
    schema_path: Path = Path("ocr/app/archero_guild/storage/schema.sql"),
    dry_run: bool = False,
    with_ocr: bool = False,
    strict: bool = False,
) -> list[MigratedImport]:
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--apply-schema", action="store_true", help="Apply the bundled PostgreSQL schema before migrating.")
    parser.add_argument("--schema", type=Path, default=Path("ocr/app/archero_guild/storage/schema.sql"))
