...
from archero_guild.pipeline.guild_boss import detect_boss_ranking_rows
from archero_guild.pipeline.guild_boss import _damage_text_from_ocr
from archero_guild.pipeline.guild_boss import _display_name_for_match
from archero_guild.pipeline.guild_boss import _match_roster_name
from archero_guild.pipeline.guild_boss import _repair_rank_damage_order
from archero_guild.pipeline.guild_boss import _supported_ocr_languages
from archero_guild.pipeline.guild_boss import _useful_raw_name
from archero_guild.pipeline.guild_boss import export_boss_ranking_crops
from archero_guild.pipeline.guild_boss import format_boss_damage
from archero_guild.pipeline.guild_boss import parse_boss_damage
...
class GuildBossDamageTests(unittest.TestCase):
    ...
    def test_repairs_rank_damage_unit_when_lower_rank_exceeds_previous(self) -> None:
        rankings = [
            ExtractedBossRanking("boss row 0", 0, "list", 27, "900000106", "StarVoyage", "StarVoyage", "468.31M", 468_310_000),
            ExtractedBossRanking("boss row 1", 1, "list", 28, "900000107", "RiverRun", "RiverRun", "421.21T", 421_210_000_000_000),
        ]
    ...
    def test_repairs_implausible_billion_to_million_ocr_drop(self) -> None:
        rankings = [
            ExtractedBossRanking("podium 2", 1, "podium", 2, None, "FrostByte", "FrostByte", "23.91B", 23_910_000_000),
            ExtractedBossRanking("podium 3", 2, "podium", 3, None, "Phantom7", "Phantom7", "215.71M", 215_710_000),
            ExtractedBossRanking("boss row 0", 0, "list", 4, None, "Birch", "Birch", "12.45M", 12_450_000),
            ExtractedBossRanking("boss row 1", 1, "list", 5, None, "ShadowRider", "ShadowRider", "12.30M", 12_300_000),
        ]
    ...
    def test_keeps_valid_trillion_top_rank(self) -> None:
        rankings = [
            ExtractedBossRanking("boss podium 1", 0, "podium", 1, "900000108", "EmberOne", "EmberOne", "2.50T", 2_500_000_000_000),
            ExtractedBossRanking("boss podium 2", 1, "podium", 2, "900000109", "FrostByte", "FrostByte", "623.49B", 623_490_000_000),
        ]
    ...
    def test_matches_cjk_roster_names(self) -> None:
        ...
        self.assertIsNotNone(_match_roster_name("| 測 試 玩 家 ﹒ 沙", [Entry()]))
    ...
    def test_matches_cyrillic_roster_names(self) -> None:
        ...
        self.assertIsNotNone(_match_roster_name("! ИСКАТЕЛЬ 4", [Entry()]))
