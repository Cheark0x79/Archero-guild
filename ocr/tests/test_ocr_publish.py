...
class OcrPublishTests(unittest.TestCase):
    ...
    def test_validates_before_publishing(self) -> None:
        ...
        with patch("archero_guild.ocr.publish._post_json", side_effect=responses) as post:
    ...
    def test_stops_when_validation_refuses_batch(self) -> None:
        with patch(
            "archero_guild.ocr.publish._post_json",
    ...
    def test_target_check_requires_a_working_database_source(self) -> None:
        ...
        with patch("archero_guild.ocr.publish.urllib.request.urlopen", return_value=response):
    ...
    def test_reads_sanitized_import_history(self) -> None:
        ...
        with patch("archero_guild.ocr.publish.urllib.request.urlopen", return_value=response) as open_url:
